...
<button class="modal_btn {{$type}}" title="{{$title}}" type="submit">
    @if($type === 'add')
        <svg class="modal_btn_icon" width="25" height="24" viewBox="0 0 25 24" fill="none"
            ...
            <path d="M11.5 13H5.5V11H11.5V5H13.5V11H19.5V13H13.5V19H11.5V13Z" fill="#1D1B20"/>
        </svg>
    @elseif($type === 'checked')
    ...
    @elseif($type === 'delete')
        <svg class="modal_btn_icon" width="24" height="24" viewBox="0 0 24 24" fill="none"
             xmlns="http://www.w3.org/2000/svg">
            <path
