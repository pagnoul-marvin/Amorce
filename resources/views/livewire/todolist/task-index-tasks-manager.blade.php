<div>
    ...
    <section class="section task_index_tasks_manager_section flex"
             x-data="{openToDo : @entangle('isToDoSectionVisible'), openInProcess : @entangle('isInProcessSectionVisible'), openArchived : @entangle('isArchivedSectionVisible') }">
        ...
        <div class="task_index_tasks_manager_section_lists_container flex">
            ...
            <div class="task_index_tasks_manager_section_lists_container_section flex">
                ...
                <h2 class="hel_bold task_index_tasks_manager_section_lists_container_section_title"
                    wire:click="toggleInProcessSection">
                    <span class="text_orange">{{__('texts.in_process_tasks')}}</span>
                    <svg x-show="openInProcess" width="22" height="18"
                         viewBox="0 0 22 18" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <style>
                                .table_icon {
                ...
                <div class="flex horizontal_flex" x-show="openInProcess">

                    <livewire:todolist.owner-in-process-tasks-of-the-day-list :$date/>

                    <livewire:todolist.assigned-in-process-tasks-of-the-day-list :$date/>
            ...
            <div class="task_index_tasks_manager_section_lists_container_section flex">
                ...
                <h2 class="hel_bold task_index_tasks_manager_section_lists_container_section_title"
                    wire:click="toggleArchivedSection">
                    <span class="text_red">{{__('texts.archived_tasks')}}</span>
                    <svg x-show="openArchived" width="22" height="18"
                         viewBox="0 0 22 18" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                            <style>
                                .table_icon {
                ...
                <div class="horizontal_flex flex" x-show="openArchived">

                    <livewire:todolist.owner-archived-tasks-of-the-day-list :$date/>

                    <livewire:todolist.assigned-archived-tasks-of-the-day-list :$date/>
    ...
    <livewire:modals.task-create-modal/>

    <livewire:messages.task-archived-confirmation-message/>
