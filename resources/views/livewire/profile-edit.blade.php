<div>
    ...
    <section class="profile_form_section flex">
        ...
        <form class="profile_form_section_form flex" wire:submit="save" enctype="multipart/form-data">

            <x-layout.input-label-container id="firstname" class="profile_form_section_form_label_and_input_container"
            ...
            <x-layout.input-label-container id="lastname" class="profile_form_section_form_label_and_input_container"
            ...
            <x-layout.input-label-container id="email" class="profile_form_section_form_label_and_input_container"
            ...
            <x-layout.input-label-container id="picture" class="profile_form_section_form_label_and_input_container"
                                            :label="__('texts.profile_photo_form')">

                <input class="input" type="file" id="picture" wire:model.blur="form.picture"
                       value="{{old('form.picture')}}">
            ...
            <x-form.submit-button :text="__('texts.modify')"
                                  div_class="profile_form_section_form_label_and_input_container"
                                  btn_class="profile_form_section_form_submit_btn submit_btn button"/>
