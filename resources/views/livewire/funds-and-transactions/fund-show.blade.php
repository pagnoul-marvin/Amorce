<div>
    ...
    <livewire:funds-and-transactions.fund-edit :$fund wire:key="fund-show-fund-section"/>

    <livewire:funds-and-transactions.fund-transactions :$fund wire:key="fund-show-transactions-section"/>
